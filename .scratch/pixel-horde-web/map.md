...
- [Grilling: หน้าแรก/ล็อกอิน และด่านสอนเล่นใน Chapter 1](issues/24-title-screen-and-tutorial.md): หน้าแรกปุ่ม "เล่น" กลางจอ + เมนูรอง + คลังสะสม, ภาพพื้นหลัง Gemini 2 ภาพ (16:9/9:16) + เอฟเฟกต์ด้วยโค้ด, ถามชื่อเล่นอย่างเดียว ชวนผูก Google 2 ครั้ง, สอนเล่นแบบข้อความสั้นไม่หยุดเกม + สอนตอนเจอครั้งแรก, รอบแรกสุด Greenvale ง่ายลงเล็กน้อย
- [Grilling: รายการเนื้อหาและระบบที่จะเพิ่ม](issues/09-content-and-systems-expansion.md): มอน 3 บทบาทต่อดินแดนครบ 10 แห่ง, achievement ~30 + ฉายา, สมุดรวมมอนแบบเบา, ภารกิจรายวันไว้หลังเปิด, สกินเป็นชุดสี, juice 9 อย่างในรุ่นแรก (ชื่อคอมโบ, ป้ายราชา, ภาพช้าตอนราชาตาย, ฉากวิวัฒน์, Kill Streak, เอฟเฟกต์สถานะ, ท่าตาย, ดูดของ, เสียง/เพลง ZzFX)
- [Grilling: แบ่งรุ่นปล่อย และเรื่องที่ยังค้างในแผนที่](issues/25-release-slicing.md): รุ่นแรกมีดินแดนครบ 10 + ระบบหลักทั้งหมด + Admin แกนหลัก/สถิติพื้นฐาน, อัปเดตทีหลัง: หัวใจร้าว 4–10, ย้ายโฮสต์, ด่านประจำวัน + กันโกงขั้น 2, Admin ส่วนเสริม · เป้า 60 FPS บนมือถือกลาง, แปลภาษาโดย Claude + ผู้ใช้ตรวจ, เพลง ZzFXM 13 เพลง
...
<!-- ว่าง: ทุกเรื่องถูกตัดสินหรือย้ายไปนอกขอบเขตแล้ว (2026-09-25) -->
...
- วัด co-op จริง (latency ของ Durable Object จากไทย, P2P บน AIS/True/dtac, TURN ต้องผูกบัตรไหม): เป็นงานตรวจตอน spike co-op แรกระหว่างลงมือทำ ไม่กระทบการตัดสินใจใน blueprint (มีทางสำรองแล้ว #03/#17)
- ภารกิจรายวัน/รายสัปดาห์, หัวใจร้าว 4–10, co-op ย้ายโฮสต์, ด่านประจำวัน + กันโกงขั้น 2, Admin ส่วนเสริม: เป็นอัปเดตหลังรุ่นแรก ออกแบบไว้แล้วใน ticket ที่เกี่ยวข้อง (#25)
