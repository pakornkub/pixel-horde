...
- [Grilling: ระบบสกิล v2](issues/18-skill-system-v2.md): ช่อง 4/3 + ช่องเก็บ 1→3 (ซื้อเพิ่ม), สลับตอนจบด่านด้วย Gold, Link 2 ใน 3 → ตื่นพลังตอนจบด่าน, คอมโบ 7 แบบจากสถานะ 5 แบบ (co-op เฉพาะของตัวเอง), ดินแดนมีลักษณะเด่นและทนธาตุตัวเอง, แต้มสกิลใช้ reroll/banish/อัปทันที, เป้าความกดดันต่อ Chapter
