...
**เพิ่มเติม 2026-09-25**: รองรับหลายโลกในอนาคตแบบเบา ข้อมูลเนื้อหา (ดินแดน, มอน, ราชา, อาวุธ, ข้อความเรื่อง) อยู่ใต้ `packages/sim/content/<world>/` (ตอนนี้มีแค่ `lumora`), `createSim` รับ `world` ตอนเริ่มรอบ, i18n แยก namespace ตามโลก, Balance Config schema = ค่ากลาง + ค่าเฉพาะโลก **ยังไม่สร้างระบบเสียบกฎพิเศษของโลก** จนกว่าจะมีโลกที่ 2 จริง (มีแบบเดียวยังไม่ถือเป็นจุดเสียบจริง)
