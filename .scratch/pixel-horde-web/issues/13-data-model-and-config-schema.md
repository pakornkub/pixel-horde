...
เพิ่มจาก #22: เก็บ checkpoint ของรอบที่พัก (blob ~5–20 KB + hash + chapter + config_version), `runs.status` เพิ่ม `suspended`, เก็บช่วงเวลาพัก/กลับมาเพื่อคำนวณเวลาเล่นจริง
