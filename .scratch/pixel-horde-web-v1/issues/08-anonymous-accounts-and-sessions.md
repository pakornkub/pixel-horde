...
**What to build:** On first launch a player enters a nickname (or skips and gets "Herowayfinder #1234") and gets an anonymous Supabase account. Only one place plays at a time: a second tab shows "game open in another tab" with "use this tab instead", and a newer login elsewhere makes the older device show "account opened elsewhere".
