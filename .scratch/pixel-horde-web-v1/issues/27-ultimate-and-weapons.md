...
- Weapons (`data/weapons.ts`): Judgement (default) + Thornwhip (roots), Sunblade (Burning), Bone Scythe (reaps normal monsters under 20% HP), Glacier Lance (freezes; bosses slowed). The six Weapons of future Realms are defined but unavailable. A Weapon changes only the Ultimate (and its colour).
