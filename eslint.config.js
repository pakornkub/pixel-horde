...
export default tseslint.config(
  { ignores: ['.claude/**', '**/dist/**', '**/node_modules/**', '**/.wrangler/**', 'pixel-horde.html', '.scratch/**', 'docs/**', 'tests/browser/.out/**', 'scripts/playtest/.out/**', 'apps/game/src/render/sprites.ts', 'apps/game/src/render/tiles.ts'] },
